...
| F-105 | Member Profile & Consents | CAP-1.6 | All | View/edit contact details (first_name/last_name + structured address per DEC-6), membership status, join date, consents, and communication preferences. | MVP |
...
| `first_name` / `last_name` (+ structured address) | Member name/address model per DEC-6. | standalone editable `legal_name` |
